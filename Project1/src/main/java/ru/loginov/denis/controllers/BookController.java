...
public class BookController {
    ...
    public String show(@PathVariable("id") int id, Model model, @ModelAttribute("person") Person person){
        ...
        Optional<Person> bookOwner = bookDAO.showBookOwner(id);
    ...
    @PatchMapping("/{id}")
    public String update(@ModelAttribute("book") @PathVariable("id") int id, @Valid Book book, BindingResult bindingResult){
        if(bindingResult.hasErrors()){
            return "books/update";
        }
